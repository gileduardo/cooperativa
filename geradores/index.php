            ...
            <div class="collapse navbar-collapse" id="itens">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown ps-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../coletas/create.php" class="dropdown-item">Nova / Iniciar</a></li>
                            <li><a href="../coletas/aberto.php" class="dropdown-item">Em aberto</a></li>
                            <li><a href="../coletas/recebidas.php" class="dropdown-item">Recebida</a></li>
                            <li><a href="../coletas/atendimento.php" class="dropdown-item">Em atendimento</a></li>
                            <li><a href="../coletas/finalizado.php" class="dropdown-item">Recebido / Finalizado</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                        ...
                        <li><a href="../catadores/index.php" class="dropdown-item">Catador</a></li>
                            <li><a href="index.php" class="dropdown-item">Gerador de Resíduos</a></li>
        ...
        <div class="row">
            <div class="col">
                <table class="table align-middle caption-top table-striped">
                    <caption>Tabela de <b>Geradores de Resíduos</b></caption>
                    <thead>
                    <tr>
                        <th scope="col">NOME</th>
                        <th scope="col">BALNEÁRIO</th>
                    ...
                    <tbody>
                        <tr>
                            <td>ESCOLA ANITA MIRÓ VERNALHA</td>
                            <td>IPANEMA</td>
                            <td class="d-none d-md-table-cell">(41)92004-1766</td>
                        ...
                        <tr>
                            <td>ESCOLA SULLY DA ROSA VILARINHO</td>
                            <td>PONTAL DO SUL</td>
                            <td class="d-none d-md-table-cell">(41)3455-1560</td>
                            <td class="d-none d-md-table-cell">ATIVO</td>
                            <td>
                                <a href= "" class="btn btn-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FFF" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
