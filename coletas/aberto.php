        ...
        <div class="row">
            <div class="col">
                <table class="table align-middle caption-top table-striped">
                    <caption>Tabela de <b>Pedidos em Aberto</b></caption>
                    <thead>
                    <tr>
                        <th scope="col">GERADOR DO RESÍDUO</th>
                        <th scope="col" class="d-none d-md-table-cell">RESÍDUO</th>
                        <th scope="col">CATADOR</th>
                        <th scope="col"></th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>ESCOLA ANITA MIRÓ VERNALHA (IPANEMA)</td>
                            <td class="d-none d-md-table-cell">Plástico e Papel</td>
                            <td>
                                <select 
                                    name="catador"
                                    class="form-select"
                                    required
                                >
                                    <option>MARCOS AURÉLIO ALVES SOUZA (OLHO D'AGUA)</option>
                                    <option>RAFAELA RIBEIRO DA SILVA (PONTAL DO SUL)</option>
                                </select>
                            </div>
                            <td>
                        ...
                        <tr>
                            <td>ESCOLA SULLY DA ROSA VILARINHO (PONTAL DO SUL)</td>
                            <td class="d-none d-md-table-cell">Metal e Alumínio</td>
                            <td>
                                <select 
                                    name="catador"
                                    class="form-select"
