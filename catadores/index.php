            ...
            <div class="collapse navbar-collapse" id="itens">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown ps-2">
                        ...
                        <ul class="dropdown-menu">
                        <li><a href="index.php" class="dropdown-item">Catador</a></li>
        ...
        <div class="row">
            <div class="col">
                <table class="table align-middle caption-top table-striped">
                    <caption>Tabela de <b>Catadores</b></caption>
                    <thead>
                    <tr>
                    ...
                    <tbody>
                        <tr>
                            <td>MARCOS AURÉLIO ALVES SOUZA</td>
                            <td>OLHO D'AGUA</td>
                            <td class="d-none d-md-table-cell">(41)99956-7834</td>
                        ...
                        <tr>
                            <td>RAFAELA RIBEIRO DA SILVA</td>
                            <td>PONTAL DO SUL</td>
                            <td class="d-none d-md-table-cell">(41)98806-0090</td>
                            <td class="d-none d-md-table-cell">ATIVO</td>
                            <td>
                                <a href= "" class="btn btn-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FFF" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
